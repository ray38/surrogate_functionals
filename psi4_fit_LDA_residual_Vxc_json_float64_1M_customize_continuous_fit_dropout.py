...
def lda_c( n, x):
    ...
    #C1 = -0.45816529328314287
    rs = (C0I / n) ** (1 / 3.)
    ec, decdrs_0 = G(rs ** 0.5, gamma, alpha1, beta1, beta2, beta3, beta4)

    return ec - rs * decdrs_0 /3.
...
if __name__ == "__main__":
    ...
    model_save_dir = working_dir + "/" + "NN_LDA_residual_1M_{}_{}_{}_Dropout_test".format(setup["NN_setup"]["number_neuron_per_layer"], setup["NN_setup"]["number_layers"], setup["NN_setup"]["activation"])
    ...
    for fit_setup in fit_setup['fit_setup']:
        ...
        tol = fit_setup['tol']
        fit_model(result, dens, X_train, residual, loss, tol, slowdown_factor, early_stop_trials*5)
