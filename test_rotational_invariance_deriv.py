...
for gradient, stencil_type in [("first","mid"), ("second","times2"), ("third","times2")]:
	...
	for theta1, theta2, theta3 in paramlist:
		...
		print "{}\t{}\t{}\t{}\t{}".format(counter,gradient,error/truth, truth, error)
...
d = {"order":gradient_list, "error":result_error_list, "percent_error":result_percent_error_list, "theta1":theta1_list, "theta2":theta2_list, "theta3": theta3_list}
