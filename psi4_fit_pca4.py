...
if __name__ == "__main__":
    ...
    plot_result(L, molecule_name, molecule_label, "rPCA_result_plot_{}_{}_L.png".format(dataset_name,10),10, edge=(-5,20,-5,25))
    plot_result(L, molecule_name, molecule_label, "rPCA_result_plot_{}_{}_L_log_log.png".format(dataset_name,10),10, edge=(-5,20,-5,25),x_scale = "symlog",y_scale="symlog")

    plot_result(L, molecule_name, molecule_label, "rPCA_result_plot_{}_{}_S.png".format(dataset_name,10),10, edge=(-5,20,-5,25))
    plot_result(L, molecule_name, molecule_label, "rPCA_result_plot_{}_{}_S_log_log.png".format(dataset_name,10),10, edge=(-5,20,-5,25),x_scale = "symlog",y_scale="symlog")
