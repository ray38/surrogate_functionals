...
if __name__ == "__main__":
    ...
    model_save_dir = working_dir + "/" + "NN_1M_{}_{}_{}_polyfeature_{}".format(setup["NN_setup"]["number_neuron_per_layer"], setup["NN_setup"]["number_layers"], setup["NN_setup"]["activation"],polynomial_order)
    ...
    for fit_setup in fit_setup['fit_setup']:
        ...
        tol = fit_setup['tol']
        fit_model(dens, X_poly, y, y, loss, tol, slowdown_factor, early_stop_trials)
