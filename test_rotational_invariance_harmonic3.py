...
for x0, y0, z0 in origin_list:
	...
	#	for l, m in [(1,0)]:
			...
			if m == 1:
				...
				stencil_Re_2, stencil_Im_2, pad = calc_harmonic_stencil(h, h, h, r, l, -1, accuracy = 6)
			...
			truth = get_result(x,y,z,sig_x,sig_y,sig_z,x0,y0,z0, h, stencil_Re_1, stencil_Re_2, stencil_Im_1, stencil_Im_2, pad)
			...
			for theta1, theta2, theta3 in paramlist:
				...
				error = get_result(x_temp, y_temp, z_temp,sig_x,sig_y,sig_z,x0,y0,z0, h, stencil_Re_1, stencil_Re_2, stencil_Im_1, stencil_Im_2, pad) - truth
