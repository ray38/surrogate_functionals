...
def process_one_molecule(molecule, model_dict, functional,h,N,log_filename, target,gamma, num_desc_deri, num_desc_deri_squa, num_desc_ave_dens,parent_dir):
    cwd = os.getcwd()
...
#        raise NotImplementedError
    ...
    for i,j,k in paramlist:
        ...
        sum_error, y_predict_sum, y_sum = process_each_block(molecule, model_dict, functional,i,j,k,h,N,log_filename, target,gamma, num_desc_deri, num_desc_deri_squa, num_desc_ave_dens,parent_dir)
