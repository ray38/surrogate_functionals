...
def plot_result(data,sig_x, sig_y, sig_z):
	...
	plt.tight_layout()
	plt.savefig("harmonic_rotational_invariance_test_percent_error_0.png")
	...
	ax.text(0.0, -0.0, "sig_x: {}   sig_y: {}  sig_z: {}".format(round(sig_x,3), round(sig_y,3), round(sig_z,3)), ha ='left', fontsize = 10)
	plt.tight_layout()
	plt.savefig("harmonic_rotational_invariance_test_error_0.png")
	...
	ax.text(0.0, -0.0, "sig_x: {}   sig_y: {}  sig_z: {}".format(round(sig_x,3), round(sig_y,3), round(sig_z,3)), ha ='left', fontsize = 10)
	plt.tight_layout()
	plt.savefig("harmonic_rotational_invariance_test_percent_error_log_0.png")
	...
	ax.text(0.0, -0.0, "sig_x: {}   sig_y: {}  sig_z: {}".format(round(sig_x,3), round(sig_y,3), round(sig_z,3)), ha ='left', fontsize = 10)
	plt.tight_layout()
	plt.savefig("harmonic_rotational_invariance_test_error_log_0.png")
...
for x0, y0, z0 in origin_list:
	...
	#	for l, m in [(1,0)]:
			...
			for theta1, theta2, theta3 in paramlist:
				...
				error = get_result(x_temp, y_temp, z_temp,sig_x,sig_y,sig_z,x0,y0,z0, h, stencil_dict[r]["Re_0_1"], stencil_dict[r]["Re_0_2"], stencil_dict[r]["Im_0_1"], stencil_dict[r]["Im_0_2"], pad)  - truth
