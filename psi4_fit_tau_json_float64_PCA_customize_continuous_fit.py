...
if __name__ == "__main__":
    ...
    model_save_dir = working_dir + "/" + "NN_{}_{}_{}_PCA_{}".format(setup["NN_setup"]["number_neuron_per_layer"], setup["NN_setup"]["number_layers"], setup["NN_setup"]["activation"],PC_component)
