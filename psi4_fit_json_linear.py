...
def fit_with_Linear(X,y):
    ...
    filename = "Linear_no_interception_model.sav"


    poly_model = linear_model.LinearRegression(fit_intercept=False)
    poly_model.fit(X, y)
...
if __name__ == "__main__":
    ...
    model_save_dir = working_dir + "/" + "NN_linear_no_interception"
    ...
    residual,poly_model = fit_with_Linear(dens,y)
