...
from convolutions import get_first_grad_stencil, get_second_grad_stencil, get_third_grad_stencil, get_harmonic_fftconv, calc_harmonic_stencil,calc_MC_surface_harmonic_stencil
import itertools
...
def f1(x,y,z,sig_x,sig_y,sig_z,x0,y0,z0,rotation_symm):
	...
	return f(x-x0,y-y0,z-z0,sig_x,sig_y,sig_z,rotation_symm)
...
def f(x,y,z,sig_x,sig_y,sig_z,rotation_symm):
...
#plot_n = f1(x,y,z,0.1, 0.1, 0.1, 0.0, 0.0, 0.0,test_rot_symmetry)
	...
	for r in [ 0.10, 0.18]:
		for l, m in [(1, 3), (2, 6)]:
			...
			for temp_result in temp_result_list:
				...
				print "origin:{}\t{}\t{}\t{}\t{}".format(counter_origin,r, counter, truth, error)
