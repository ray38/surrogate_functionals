...
def get_result(x_temp, y_temp, z_temp,sig_x,sig_y,sig_z,x0,y0,z0, r, h, stencil_x,stencil_y,stencil_z, pad):

	n = f(x_temp, y_temp, z_temp,sig_x,sig_y,sig_z,x0,y0,z0)

	temp_x,_ = get_fftconv_with_known_stencil_no_wrap(n,h,h,h,r,stencil_x,pad)
	temp_y,_ = get_fftconv_with_known_stencil_no_wrap(n,h,h,h,r,stencil_y,pad)
	temp_z,_ = get_fftconv_with_known_stencil_no_wrap(n,h,h,h,r,stencil_z,pad)
...
for r in [0.02, 0.06, 0.10, 0.14, 0.18, 0.22]:
	...
	for theta1, theta2, theta3 in paramlist:
		...
		error = get_result(x_temp, y_temp, z_temp,sig_x,sig_y,sig_z,x0,y0,z0, h, r, stencil_x,stencil_y,stencil_z, pad) - truth
