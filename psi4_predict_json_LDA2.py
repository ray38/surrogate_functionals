...
def initialize(setup,NN_model_filename):
    ...
    predict_log_name = "predict_LDA_log.log"
    predict_full_log_name = "predict_LDA_full_log.log"
    predict_error_log_name = "predict_LDA_error_log.log"
    predict_formation_log_name = "predict_LDA_formation_log.log"
