...
def get_result(x_temp, y_temp, z_temp,sig_x,sig_y,sig_z,x0,y0,z0, h, stencil_Re_1, stencil_Re_2, stencil_Im_1, stencil_Im_2, pad):
	...
	temp_result_1,_ = get_fftconv_with_known_stencil_no_wrap(temp_Re,h,h,h,1,stencil_Re_2,pad)
	temp_result_2,_ = get_fftconv_with_known_stencil_no_wrap(temp_Im,h,h,h,1,stencil_Im_2,pad)
...
stencil_dict = {}
l=1
for r in [ 0.06, 0.10, 0.14, 0.18, 0.22]:
	stencil_Re_0_1, stencil_Im_0_1, pad = calc_harmonic_stencil(h, h, h, r, l, 0, accuracy = 6)
	stencil_Re_0_2, stencil_Im_0_2, pad = calc_harmonic_stencil(h, h, h, r, l, 0, accuracy = 6)

	stencil_Re_1_1, stencil_Im_1_1, pad = calc_harmonic_stencil(h, h, h, r, l, 1, accuracy = 6)
	stencil_Re_1_2, stencil_Im_1_2, pad = calc_harmonic_stencil(h, h, h, r, l, -1, accuracy = 6)


	stencil_Re_n1_1, stencil_Im_n1_1, pad = calc_harmonic_stencil(h, h, h, r, l, -1, accuracy = 6)
	stencil_Re_n1_2, stencil_Im_n1_2, pad = calc_harmonic_stencil(h, h, h, r, l, 1, accuracy = 6)

	stencil_dict[r] = {}
	stencil_dict[r]["Re_0_1"] = stencil_Re_0_1
	stencil_dict[r]["Re_0_2"] = stencil_Re_0_2
	stencil_dict[r]["Im_0_1"] = stencil_Im_0_1
	stencil_dict[r]["Im_0_2"] = stencil_Im_0_2

	stencil_dict[r]["Re_1_1"] = stencil_Re_1_1
	stencil_dict[r]["Re_1_2"] = stencil_Re_1_2
	stencil_dict[r]["Im_1_1"] = stencil_Im_1_1
	stencil_dict[r]["Im_1_2"] = stencil_Im_1_2

	stencil_dict[r]["Re_n1_1"] = stencil_Re_n1_1
	stencil_dict[r]["Re_n1_2"] = stencil_Re_n1_2
	stencil_dict[r]["Im_n1_1"] = stencil_Im_n1_1
	stencil_dict[r]["Im_n1_2"] = stencil_Im_n1_2
...
for x0, y0, z0 in origin_list:
	...
	#	for l, m in [(1,0)]:
			...
			truth = get_result(x,y,z,sig_x,sig_y,sig_z,x0,y0,z0, h, stencil_dict[r]["Re_0_1"], stencil_dict[r]["Re_0_2"], stencil_dict[r]["Im_0_1"], stencil_dict[r]["Im_0_2"], pad) + \
					get_result(x,y,z,sig_x,sig_y,sig_z,x0,y0,z0, h, stencil_dict[r]["Re_1_1"], stencil_dict[r]["Re_1_2"], stencil_dict[r]["Im_1_1"], stencil_dict[r]["Im_1_2"], pad) + \
					get_result(x,y,z,sig_x,sig_y,sig_z,x0,y0,z0, h, stencil_dict[r]["Re_n1_1"], stencil_dict[r]["Re_n1_2"], stencil_dict[r]["Im_n1_1"], stencil_dict[r]["Im_n1_2"], pad)
			...
			for theta1, theta2, theta3 in paramlist:
				...
				error = get_result(x_temp, y_temp, z_temp,sig_x,sig_y,sig_z,x0,y0,z0, h, stencil_dict[r]["Re_0_1"], stencil_dict[r]["Re_0_2"], stencil_dict[r]["Im_0_1"], stencil_dict[r]["Im_0_2"], pad) + \
						get_result(x_temp, y_temp, z_temp,sig_x,sig_y,sig_z,x0,y0,z0, h, stencil_dict[r]["Re_1_1"], stencil_dict[r]["Re_1_2"], stencil_dict[r]["Im_1_1"], stencil_dict[r]["Im_1_2"], pad) + \
						get_result(x_temp, y_temp, z_temp,sig_x,sig_y,sig_z,x0,y0,z0, h, stencil_dict[r]["Re_n1_1"], stencil_dict[r]["Re_n1_2"], stencil_dict[r]["Im_n1_1"], stencil_dict[r]["Im_n1_2"], pad) - truth
