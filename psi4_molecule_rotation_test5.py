...
if __name__ == "__main__":
    ...
    convolution_properties = ["aver 0.06", "aver 0.1", "aver 0.2", "MCHarmonic 1 0.06", "MCHarmonic 1 0.10", "MCHarmonic 1 0.20", "MCHarmonic 2 0.06", "MCHarmonic 2 0.10", "MCHarmonic 2 0.20", "MCHarmonic 3 0.06", "MCHarmonic 3 0.10", "MCHarmonic 3 0.20"]
    convolution_property_stencils = []


    stencil,pad = get_integration_stencil(h, h, h, 0.06, accuracy = get_auto_accuracy(h,h,h, 0.06))
    convolution_property_stencils.append(stencil)
    stencil,pad = get_integration_stencil(h, h, h, 0.10, accuracy = get_auto_accuracy(h,h,h, 0.10))
    convolution_property_stencils.append(stencil)
    stencil,pad = get_integration_stencil(h, h, h, 0.20, accuracy = get_auto_accuracy(h,h,h, 0.20))
    convolution_property_stencils.append(stencil)


    stencil_Re_1, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.06, 1, 1, accuracy = 6)
    stencil_Re_2, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.06, 1, 2, accuracy = 6)
    stencil_Re_3, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.06, 1, 3, accuracy = 6)
    convolution_property_stencils.append(["MC_surface_harmonic",[stencil_Re_1,stencil_Re_2,stencil_Re_3]])

    stencil_Re_1, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.10, 1, 1, accuracy = 6)
    stencil_Re_2, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.10, 1, 2, accuracy = 6)
    stencil_Re_3, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.10, 1, 3, accuracy = 6)
    convolution_property_stencils.append(["MC_surface_harmonic",[stencil_Re_1,stencil_Re_2,stencil_Re_3]])

    stencil_Re_1, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.20, 1, 1, accuracy = 6)
    stencil_Re_2, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.20, 1, 2, accuracy = 6)
    stencil_Re_3, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.20, 1, 3, accuracy = 6)
    convolution_property_stencils.append(["MC_surface_harmonic",[stencil_Re_1,stencil_Re_2,stencil_Re_3]])


    stencil_Re_1, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.06, 2, 1, accuracy = 6)
    stencil_Re_2, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.06, 2, 2, accuracy = 6)
    stencil_Re_3, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.06, 2, 3, accuracy = 6)
    stencil_Re_4, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.06, 2, 4, accuracy = 6)
    stencil_Re_5, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.06, 2, 5, accuracy = 6)
    stencil_Re_6, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.06, 2, 6, accuracy = 6)
    convolution_property_stencils.append(["MC_surface_harmonic",[stencil_Re_1,stencil_Re_2,stencil_Re_3,stencil_Re_4,stencil_Re_5,stencil_Re_6]])

    stencil_Re_1, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.10, 2, 1, accuracy = 6)
    stencil_Re_2, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.10, 2, 2, accuracy = 6)
    stencil_Re_3, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.10, 2, 3, accuracy = 6)
    stencil_Re_4, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.10, 2, 4, accuracy = 6)
    stencil_Re_5, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.10, 2, 5, accuracy = 6)
    stencil_Re_6, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.10, 2, 6, accuracy = 6)
    convolution_property_stencils.append(["MC_surface_harmonic",[stencil_Re_1,stencil_Re_2,stencil_Re_3,stencil_Re_4,stencil_Re_5,stencil_Re_6]])

    stencil_Re_1, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.20, 2, 1, accuracy = 6)
    stencil_Re_2, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.20, 2, 2, accuracy = 6)
    stencil_Re_3, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.20, 2, 3, accuracy = 6)
    stencil_Re_4, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.20, 2, 4, accuracy = 6)
    stencil_Re_5, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.20, 2, 5, accuracy = 6)
    stencil_Re_6, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.20, 2, 6, accuracy = 6)
    convolution_property_stencils.append(["MC_surface_harmonic",[stencil_Re_1,stencil_Re_2,stencil_Re_3,stencil_Re_4,stencil_Re_5,stencil_Re_6]])


    stencil_Re_1, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.06, 3, 1, accuracy = 6)
    stencil_Re_2, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.06, 3, 2, accuracy = 6)
    stencil_Re_3, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.06, 3, 3, accuracy = 6)
    stencil_Re_4, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.06, 3, 4, accuracy = 6)
    stencil_Re_5, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.06, 3, 5, accuracy = 6)
    stencil_Re_6, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.06, 3, 6, accuracy = 6)
    stencil_Re_7, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.06, 3, 7, accuracy = 6)
    stencil_Re_8, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.06, 3, 8, accuracy = 6)
    stencil_Re_9, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.06, 3, 9, accuracy = 6)
    stencil_Re_10, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.06, 3, 10, accuracy = 6)
    convolution_property_stencils.append(["MC_surface_harmonic",[stencil_Re_1,stencil_Re_2,stencil_Re_3,stencil_Re_4,stencil_Re_5,stencil_Re_6,stencil_Re_7,stencil_Re_8,stencil_Re_9,stencil_Re_10]])

    stencil_Re_1, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.10, 3, 1, accuracy = 6)
    stencil_Re_2, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.10, 3, 2, accuracy = 6)
    stencil_Re_3, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.10, 3, 3, accuracy = 6)
    stencil_Re_4, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.10, 3, 4, accuracy = 6)
    stencil_Re_5, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.10, 3, 5, accuracy = 6)
    stencil_Re_6, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.10, 3, 6, accuracy = 6)
    stencil_Re_7, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.10, 3, 7, accuracy = 6)
    stencil_Re_8, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.10, 3, 8, accuracy = 6)
    stencil_Re_9, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.10, 3, 9, accuracy = 6)
    stencil_Re_10, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.10, 3, 10, accuracy = 6)
    convolution_property_stencils.append(["MC_surface_harmonic",[stencil_Re_1,stencil_Re_2,stencil_Re_3,stencil_Re_4,stencil_Re_5,stencil_Re_6,stencil_Re_7,stencil_Re_8,stencil_Re_9,stencil_Re_10]])

    stencil_Re_1, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.20, 3, 1, accuracy = 6)
    stencil_Re_2, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.20, 3, 2, accuracy = 6)
    stencil_Re_3, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.20, 3, 3, accuracy = 6)
    stencil_Re_4, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.20, 3, 4, accuracy = 6)
    stencil_Re_5, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.20, 3, 5, accuracy = 6)
    stencil_Re_6, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.20, 3, 6, accuracy = 6)
    stencil_Re_7, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.20, 3, 7, accuracy = 6)
    stencil_Re_8, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.20, 3, 8, accuracy = 6)
    stencil_Re_9, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.20, 3, 9, accuracy = 6)
    stencil_Re_10, pad =  calc_MC_surface_harmonic_stencil(h, h, h, 0.20, 3, 10, accuracy = 6)
    convolution_property_stencils.append(["MC_surface_harmonic",[stencil_Re_1,stencil_Re_2,stencil_Re_3,stencil_Re_4,stencil_Re_5,stencil_Re_6,stencil_Re_7,stencil_Re_8,stencil_Re_9,stencil_Re_10]])
