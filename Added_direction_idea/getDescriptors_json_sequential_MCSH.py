...
from convolutions import calc_MC_surface_harmonic_legendre_gaussian_stencil_n,matrix_convolve2,get_differenciation_conv, get_integration_stencil,get_auto_accuracy,get_fftconv_with_known_stencil_no_wrap,get_asym_integration_stencil,get_asym_integration_fftconv,get_asym_integral_fftconv_with_known_stencil,calc_MC_surface_harmonic_stencil
import h5py
import os
...
def prepare_MCSH_stencils(max_legendre_order,r,h,gaussian_sigma):
    ...
    for legendre_order in range(max_legendre_order+1):
        ...
        stencil_Re_0_1, pad =  calc_MC_surface_harmonic_legendre_gaussian_stencil_n(h, h, h, r, 0, 1, legendre_order, gaussian_sigma, accuracy = 6)
        MCSH_stencil_dict["0_1"][legendre_order] = [[stencil_Re_0_1], pad ]


    for legendre_order in range(max_legendre_order+1):

        stencil_Re_1_1, pad =  calc_MC_surface_harmonic_legendre_gaussian_stencil_n(h, h, h, r, 1, 1, legendre_order, gaussian_sigma, accuracy = 6)
        stencil_Re_1_2, pad =  calc_MC_surface_harmonic_legendre_gaussian_stencil_n(h, h, h, r, 1, 1, legendre_order, gaussian_sigma, accuracy = 6)
        stencil_Re_1_3, pad =  calc_MC_surface_harmonic_legendre_gaussian_stencil_n(h, h, h, r, 1, 1, legendre_order, gaussian_sigma, accuracy = 6)
        MCSH_stencil_dict["1_1"][legendre_order] = [[stencil_Re_1_1,stencil_Re_1_2,stencil_Re_1_3], pad ]


    for legendre_order in range(max_legendre_order+1):


        stencil_Re_2_1, pad =  calc_MC_surface_harmonic_legendre_gaussian_stencil_n(h, h, h, r, 2, 1, legendre_order, gaussian_sigma, accuracy = 6)
        stencil_Re_2_4, pad =  calc_MC_surface_harmonic_legendre_gaussian_stencil_n(h, h, h, r, 2, 4, legendre_order, gaussian_sigma, accuracy = 6)
        stencil_Re_2_6, pad =  calc_MC_surface_harmonic_legendre_gaussian_stencil_n(h, h, h, r, 2, 6, legendre_order, gaussian_sigma, accuracy = 6)
        MCSH_stencil_dict["2_1"][legendre_order] = [[stencil_Re_2_1,stencil_Re_2_4,stencil_Re_2_6], pad ]


        stencil_Re_2_2, pad =  calc_MC_surface_harmonic_legendre_gaussian_stencil_n(h, h, h, r, 2, 2, legendre_order, gaussian_sigma, accuracy = 6)
        stencil_Re_2_3, pad =  calc_MC_surface_harmonic_legendre_gaussian_stencil_n(h, h, h, r, 2, 3, legendre_order, gaussian_sigma, accuracy = 6)
        stencil_Re_2_5, pad =  calc_MC_surface_harmonic_legendre_gaussian_stencil_n(h, h, h, r, 2, 5, legendre_order, gaussian_sigma, accuracy = 6)
        MCSH_stencil_dict["2_2"][legendre_order] = [[stencil_Re_2_2,stencil_Re_2_3,stencil_Re_2_5], pad ]

    for legendre_order in range(max_legendre_order+1):


        stencil_Re_3_2, pad =  calc_MC_surface_harmonic_legendre_gaussian_stencil_n(h, h, h, r, 3, 2, legendre_order, gaussian_sigma, accuracy = 6)
        stencil_Re_3_3, pad =  calc_MC_surface_harmonic_legendre_gaussian_stencil_n(h, h, h, r, 3, 3, legendre_order, gaussian_sigma, accuracy = 6)
        stencil_Re_3_4, pad =  calc_MC_surface_harmonic_legendre_gaussian_stencil_n(h, h, h, r, 3, 4, legendre_order, gaussian_sigma, accuracy = 6)
        stencil_Re_3_6, pad =  calc_MC_surface_harmonic_legendre_gaussian_stencil_n(h, h, h, r, 3, 6, legendre_order, gaussian_sigma, accuracy = 6)
        stencil_Re_3_8, pad =  calc_MC_surface_harmonic_legendre_gaussian_stencil_n(h, h, h, r, 3, 8, legendre_order, gaussian_sigma, accuracy = 6)
        stencil_Re_3_9, pad =  calc_MC_surface_harmonic_legendre_gaussian_stencil_n(h, h, h, r, 3, 9, legendre_order, gaussian_sigma, accuracy = 6)
        MCSH_stencil_dict["3_1"][legendre_order] = [[stencil_Re_3_2,stencil_Re_3_3,stencil_Re_3_4,stencil_Re_3_6,stencil_Re_3_8,stencil_Re_3_9], pad ]


        stencil_Re_3_1, pad =  calc_MC_surface_harmonic_legendre_gaussian_stencil_n(h, h, h, r, 3, 1, legendre_order, gaussian_sigma, accuracy = 6)
        stencil_Re_3_7, pad =  calc_MC_surface_harmonic_legendre_gaussian_stencil_n(h, h, h, r, 3, 7, legendre_order, gaussian_sigma, accuracy = 6)
        stencil_Re_3_10, pad =  calc_MC_surface_harmonic_legendre_gaussian_stencil_n(h, h, h, r, 3, 10, legendre_order, gaussian_sigma, accuracy = 6)
        MCSH_stencil_dict["3_2"][legendre_order] = [[stencil_Re_3_1,stencil_Re_3_7,stencil_Re_3_10], pad ]


        stencil_Re_3_5, pad =  calc_MC_surface_harmonic_legendre_gaussian_stencil_n(h, h, h, r, 3, 5, legendre_order, gaussian_sigma, accuracy = 6)
        MCSH_stencil_dict["3_3"][legendre_order] = [[stencil_Re_3_5], pad ]
...
def process_one_molecule(molecule, functional,h,L,N,r,max_legendre_order, gaussian_sigma):
    cwd = os.getcwd()
    MCSH_stencil_dict = prepare_MCSH_stencils(max_legendre_order,r,h, gaussian_sigma)
...
if __name__ == "__main__":
    ...
    if choice == 'single':
        ...
        r = float(setup["r"])
        max_legendre_order = int(setup['max_legendre_order'])
        gaussian_sigma = float(setup["gaussian_sigma"])

        #for functional in functionals:
        print "start process molecule"
        process_one_molecule(molecule, functional,h,L,N,r,max_legendre_order,gaussian_sigma)
