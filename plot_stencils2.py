...
def plot(array, reference_shape, filename):
	...
	sns.heatmap(pad(array,reference_shape), cmap="RdBu_r", center=0., yticklabels=False, xticklabels=False, cbar=False, annot=True)
...
for key in stencil_dict:
	print key
	plot(stencil_dict[key], 9, "integration_stencil_plot_{}.png".format(key))
...
plot(temp_first_deri[(temp_first_deri.shape[1]-1)/2], 9, "gradient_stencil_plot_1.png")
...
plot(temp_sec_deri[(temp_sec_deri.shape[1]-1)/2], 9, "gradient_stencil_plot_2.png")
...
plot(temp_third_deri[(temp_third_deri.shape[1]-1)/2], 9, "gradient_stencil_plot_3.png")
